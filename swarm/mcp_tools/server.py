...
class SwarmMCPServer:
    ...
    def _register_all_tools(self):
        ...
        @self.mcp.tool
        async def extract_page_content(query: Optional[str] = None, max_length: int = 20000) -> Dict[str, Any]:
            """
    ...
    def extract_page_content(self, query: Optional[str] = None, max_length: int = 20000) -> Dict[str, Any]:
